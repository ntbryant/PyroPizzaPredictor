...
date_range <- seq.Date(from=as.Date('2016-12-19'), to=as.Date('2017-04-20'), by='1 month')
...
weather[conditions=="",conditions:=
          ifelse(visibility_avg<=8 & visibility_avg>6,"Mostly Cloudly","")]
weather[conditions=="",conditions:=
          ifelse(visibility_avg<=6 & visibility_avg>4,"Partly Cloudly","")]
weather[conditions=="",conditions:=
...
train[,':=' (temp_maxz=scale(temp_max),
